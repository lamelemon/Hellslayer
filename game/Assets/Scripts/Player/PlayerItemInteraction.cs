...
public class PlayerInteraction : MonoBehaviour
{
    ...
    private void EnableWeaponScript(GameObject itemObject)
    {
        // Disable all other RPG scripts on other items first
        ...
        // Enable RPG script only if this item has one
    ...
    private void DisableWeaponScript(GameObject itemObject)
    {
